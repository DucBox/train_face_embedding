...
OUTPUT_FINAL_DIR = "/workspace/FaceNist/raw_data_processing/output_parquet/data_process/face_embedding_normalize/clean_data/v1_flat"
...
def run_pipeline():
    ...
    if NUM_DEBUG_IDS is not None:
        print(f"!!! DEBUG MODE: Processing first {NUM_DEBUG_IDS} IDs only !!!")
    ...
    # --- STEP 2: FAISS FLAT SEARCH (EXACT) ---
    print(f"[STEP 2] Building FAISS IndexFlatIP (Exact Search)...")
    ...
    # Cast types for NumPy compatibility
