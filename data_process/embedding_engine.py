...
MODEL_WEIGHT_PATH = "/workspace/FaceNist/Models/vit_cos_no_augment/model_epoch_59.pt"
DEVICE = "cuda" if torch.cuda.is_available() else "cpu"

CROP_CHECKPOINT = "/workspace/FaceNist/crawled-dataset-processing/public5m_embedding/checkpoints_p2.txt"
EMBED_CHECKPOINT = "/workspace/FaceNist/crawled-dataset-processing/public5m_embedding/checkpoints_embedding_p2.txt"
OUTPUT_DIR = "/workspace/FaceNist/crawled-dataset-processing/public5m_embedding/public5m_embeddings_output_p2"
SHARD_SIZE = 10000
        ...
        for pid in tqdm(todo_pids, desc="Embedding"):
            ...
            try:
                ...
                if len(buffer_data) >= SAVE_BATCH_SIZE:
                    ...
                    print(f"[SAVE] Saved {len(df)} rows to {save_path}")
